...
@Controller() //precisa do decorator para receber injeções de dependencias
export class InvoicesConsumer {
  private logger = new Logger(InvoicesConsumer.name);

  constructor(private fraudService: FraudService) {}

  @EventPattern('pending_transactions') // para o método receber as mensagens do tópico
...
// 2 formas de executar o consumidor:
// juntamente com http
